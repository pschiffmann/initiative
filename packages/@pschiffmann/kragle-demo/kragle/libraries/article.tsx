...
export const Article$getId: ArticleLibraryMembers["getId"] = (article) =>
  `${article.id}`;

export const Article$getName: ArticleLibraryMembers["getName"] = (article) =>
  article.name;

export const Article$getFormattedPrice: ArticleLibraryMembers["getFormattedPrice"] =
  (article) => {
...
export const Article$parseFormattedPrice: ArticleLibraryMembers["parseFormattedPrice"] =
  (input) => {
